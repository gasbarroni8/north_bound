...
cash_flow_sh.iloc[:, :10].plot(kind='bar', stacked=True, figsize=(20, 10), legend=True,ax=ax)
plt.legend(bbox_to_anchor=(0.5, -0.15), loc='upper center', ncol=3)
ax2 = ax.twinx()
hk_to_all['sh_net_purchases'].plot(kind='bar', legend=False, ax=ax2, edgecolor='r', linewidth=3, facecolor='none')
...
plt.show()
fig.savefig(sub_file_path+'\\%s.png' % f'SH:Northbound Cash Flow 1-10_{cash_flow.index[-1]:%Y-%m-%d}')
